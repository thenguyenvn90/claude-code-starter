...
- **PR size ceiling: ~200 lines target, 400 lines max.** Above that, review collapses. Split refactors from features.
...
- **Verify every claim.** Function exists? Open the file. Tests pass? Run them. API cited? Check the docs. Trust nothing unverified.
- **Re-audit after every revision.** Every fix is a new change. Same rigor, no exceptions.
